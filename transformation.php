    ...
    <body>
        ...
        <div class="body-inner">
            ...
            <div class="event-div event-flex no-bg-event "> 
                <img src="./assets/img/stft.png" class="event-poster wd-37" data-aos="fade-right">
                <div class="event-info">
                    <p class="event-title">Speak to a Fortune 5 Day Workshop Recording<span>Exclusive Community</span></p>
                    ...
                    <p class="old-value1">RS.800</p>
                    <p class="cart-value1">RS.400 only</p>
                </div>
                </div>
            </div>
            
            <div class="event-div event-flex no-bg-event "> 
                <img src="./assets/img/bmt.png" class="event-poster wd-37" data-aos="fade-right">
                <div class="event-info">
                    <p class="event-title">Business Mastermind 5 Day Workshop Recording<span>Exclusive Community</span></p>
                    <p class="event-subtitle">Be part of the exclusive mastermind group where you will meet awesome,
                        amazing people who are driven to help others, are go getters! Take your life
                        to a new level just by being part of this community!
                    </p>
            ...
            <div class="footer-offer">
                ...
                <input type="hidden" id="myid" name="hidden_id" value="<?php echo $id ?>" />
                        <input type="hidden" id="title2" name="hidden_name" value="The Secret Wealth Formula" />
                          <input type="hidden" id="desc2" name="hidden_desc" value="Discover the money blueprint of millionaires and create a legacy" />
                          <input type="hidden" id="mprice3" name="hidden_ogprice" value="82997" />
                          <input type="hidden" id="oprice3" name="hidden_offerprice" value="8200" />
