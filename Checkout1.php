	...
	<form method="post" name="customerData" action="ccavRequestHandler.php" style="display:none;">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Order Id	:</td><td><input type="text" name="order_id" value="<?php echo $_POST["id"]."_".rand(10,100); ?>"/></td>
				</tr>
				<!--<tr>-->
				...
				<!--</tr>-->
				<!--	<tr>-->
				<!--	<td>si_mer_ref_no	:</td><td><input type="text" name="si_mer_ref_no" value="379508"/></td>-->
				<!--</tr>-->
				<!--	<tr>-->
				<!--	<td>si_is_setup_amt	:</td><td><input type="text" name="si_is_setup_amt" value="Y"/></td>-->
				<!--</tr>-->
				<!--<tr>-->
				<!--	<td>si_amount	:</td><td><input type="text" name="si_amount" value="10"/></td>-->
				<!--</tr>-->
				<tr>
					<td>amount	:</td><td><input type="text" name="amount" value="<?php echo $_POST['price']; ?>"/></td>
				</tr>
				<!--<tr>-->
				<!--	<td>si_start_date	:</td><td><input type="text" name="si_start_date" value="15-02-2018"/></td>-->
				<!--</tr>-->
				<!--<tr>-->
				<!--	<td>si_frequency	:</td><td><input type="text" name="si_frequency" value="1"/></td>-->
				<!--</tr>-->
				<!--<tr>-->
				<!--	<td>si_frequency_type	:</td><td><input type="text" name="si_frequency_type" value="DAYS"/></td>-->
				<!--</tr>-->
				<!--<tr>-->
				<!--	<td>si_bill_cycle	:</td><td><input type="text" name=" si_bill_cycle" value="12"/></td>-->
				<!--</tr>-->
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://arfeenkhan.com/deals/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://arfeenkhan.com/deals/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
		        ...
		        <tr>
		        	<td>Billing Name	:</td><td><input type="text" name="billing_name" value=""/></td>
		        </tr>
		        <tr>
