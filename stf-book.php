        ...
        <div class="body-inner">
            <div class="event-div book-back" style="background:#fff;display:inline-block;">
                <div class="event-info" style="float:left">
                    <p class="event-title">Speak To a Fortune </p>
                ...
                <img style="float:left;width: 35%;max-width: 100%;padding: 35px;" src="./assets/img/stf-book.png" class="event-poster" data-aos="fade-right">
            </div>
                    <div class="footer-offer" style="margin-top:0px;">
                        ...
                        <input type="hidden" id="title2" name="hidden_name" value="Speak To a Fortune" />
